...
set_property PACKAGE_PIN T5 [get_ports reset]
...
set_property IOSTANDARD LVCMOS33 [get_ports Another_Reset_Minute]
set_property IOSTANDARD LVCMOS33 [get_ports buzzerOutput]
set_property IOSTANDARD LVCMOS33 [get_ports clkinput]
set_property IOSTANDARD LVCMOS33 [get_ports reset_Hour]
set_property IOSTANDARD LVCMOS33 [get_ports reset_Minute]
set_property IOSTANDARD LVCMOS33 [get_ports reset_Second]
...
set_property PACKAGE_PIN Y7 [get_ports Another_Reset_Minute]
set_property PACKAGE_PIN A19 [get_ports buzzerOutput]
set_property PACKAGE_PIN Y18 [get_ports clkinput]
set_property PACKAGE_PIN T4 [get_ports reset_Hour]
set_property PACKAGE_PIN R4 [get_ports reset_Minute]
set_property PACKAGE_PIN W4 [get_ports reset_Second]


set_property DRIVE 12 [get_ports buzzerOutput]


set_property SLEW SLOW [get_ports buzzerOutput]
